...
Browser (single-page app)
  ...
  assets/css/app.css── public site + shared document styles
  ...
  assets/css/shop.css  ─ Shop Panel theme (own design system, scoped to body.shp-on)
        │
...
The panel has its own design system (`assets/css/shop.css`, scoped to
`body.shp-on`, emerald accent) with a light/dark toggle; the printed invoice
document keeps the shared print styles so paper output is unchanged.
